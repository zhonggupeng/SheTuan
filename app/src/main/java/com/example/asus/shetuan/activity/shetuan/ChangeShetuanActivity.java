...
import com.example.asus.shetuan.bean.ChangeShetuan;
import com.example.asus.shetuan.clipimage.ClipActivity;
import com.example.asus.shetuan.databinding.ActivityChangeShetuanBinding;
                ...
                if (changeShetuan.getStannouncement()==null||changeShetuan.getStannouncement().length()==0){
                    ...
                    if (imagepath == null) {
                        changeshetuanbody = new FormBody.Builder()
                                ...
                                .build();
                        if (NetWorkState.checkNetWorkState(ChangeShetuanActivity.this)) {
